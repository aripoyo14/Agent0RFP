...
export const sampleTalentProfile: TalentProfile = {
  ...
  interviewRecords: [
    ...
    },
    {
      ...
      interviewer: "高橋美里",
      summary: "デジタル人材不足の現状と育成施策について議論。リスキリング支援制度の効果測定方法と、企業と教育機関の連携体制について意見交換。特に、実践的なスキル習得の場の提供と、継続的な学習支援の仕組み作りが重要であることを確認した。",
      isLatest: false
    },
    {
      id: 5,
      ...
      interviewer: "小林健一",
      summary: "医療技術イノベーションを促進する規制改革について議論。薬事承認プロセスの合理化と安全性確保のバランス、デジタル治療アプリの評価基準について検討。海外の事例を参考に、日本の医療イノベーション環境の改善策を議論した。",
      isLatest: false
    },
    {
      id: 6,
      ...
      interviewer: "松本真由美",
      summary: "地方におけるデジタル技術活用による地域活性化について議論。スマート農業、遠隔医療、オンライン教育などの具体的な取り組み事例を検討。都市部との格差解消に向けた政策支援の在り方について意見交換を行った。",
      isLatest: false
    },
    {
      id: 7,
      ...
      interviewer: "中村宏",
      summary: "サイバーセキュリティ対策の強化と企業の競争力向上の両立について議論。ゼロトラスト・アーキテクチャの導入支援と人材育成、国際連携の重要性について検討。セキュリティ投資の効果測定方法についても意見交換した。",
      isLatest: false
    },
    {
      id: 8,
      ...
      interviewer: "藤田恵子",
      summary: "ブロックチェーン技術の実用化に向けた課題と機会について議論。金融、物流、コンテンツ産業での活用事例を検討。規制の明確化と技術標準化の必要性、国際的な競争力確保の観点から政策支援の在り方を議論した。",
      isLatest: false
    },
    {
      id: 9,
      ...
      interviewer: "井上拓也",
      summary: "量子コンピューター分野における日本の競争力強化について議論。基礎研究への投資と産業応用の橋渡し、国際共同研究の推進について検討。人材育成と研究基盤整備の重要性について意見交換を行った。",
      isLatest: false
    },
    {
      id: 10,
      ...
      interviewer: "木村亮介",
      summary: "宇宙産業の商業化促進に向けた政策について議論。衛星データ活用、宇宙輸送、宇宙利用サービスの各分野での民間企業支援策を検討。国際競争力強化と技術安全保障の観点から、戦略的な投資の在り方について意見交換した。",
      isLatest: false
    },
    {
      id: 11,
      ...
      title: "次世代モビリティと都市設計",
      interviewer: "渡辺千春",
      summary: "自動運転技術、電動モビリティ、MaaSの普及に向けた社会実装について議論。インフラ整備、法制度改正、都市計画との連携について検討。持続可能な交通システムの構築に向けた統合的なアプローチについて意見交換した。",
      isLatest: false
    },
    {
      id: 12,
      ...
      interviewer: "斉藤良太",
      summary: "バイオテクノロジーを活用した食料生産技術について議論。遺伝子組み換え技術、細胞培養肉、植物工場などの技術開発支援と規制の在り方を検討。食料自給率向上と環境負荷軽減の両立に向けた政策支援について意見交換した。",
      isLatest: false
    },
    {
      id: 13,
